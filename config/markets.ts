...
const config: {
  ...
  hardhat: [
    ...
    {
      tokens: { indexToken: "AWETH", longToken: "AWETH", shortToken: "USDC" },
    },
    {
      tokens: { indexToken: "WETH", longToken: "WETH", shortToken: "WETH" },
    },
    {
      tokens: { indexToken: "SOL", longToken: "WETH", shortToken: "WETH" },
    },
    {
      tokens: { indexToken: "WBTC", longToken: "WETH", shortToken: "WETH" },
    },
  ],
  localhost: [
    {
